...
export const Route = createFileRoute("/contacto")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Encuéntranos en Av. Madero 245, Centro, Chapala. Tel. (52) 566 174 6503." },
      ...
      <section ref={titleRef} className="mx-auto max-w-5xl px-6 py-24">
        ...
        <div className="mt-16 grid gap-10 md:grid-cols-2">
          <div className="space-y-8">
            ...
            <Reveal delay={0.08}><div className="flex gap-4"><Phone className="mt-1 h-5 w-5 text-accent" /><div><div className="text-xs uppercase tracking-widest text-muted-foreground">Teléfono</div><p>(52) 566 174 6503</p></div></div></Reveal>
            ...
            <Reveal delay={0.24}><div className="flex gap-4"><MessageCircle className="mt-1 h-5 w-5 text-accent" /><div><div className="text-xs uppercase tracking-widest text-muted-foreground">WhatsApp</div><a href="https://wa.me/5661746503" className="underline underline-offset-4 hover:text-accent">Escríbenos</a></div></div></Reveal>
          </div>
          <Reveal delay={0.1}>
